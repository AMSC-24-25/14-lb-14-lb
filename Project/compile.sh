...
g++ ${CXXFLAGS} LBM.hpp LBM.cpp VelocitySet.cpp Obstacle.hpp Obstacle.cpp LidDrivenCavity3D.hpp LidDrivenCavity3D.cpp ObstacleLiftDrag.hpp ObstacleLiftDrag.cpp  main.cpp -o ldc_sim
